...
export { dialogEmits, dialogProps } from './components/dialog/src/dialog2.mjs';
...
export { DROPDOWN_COLLECTION_INJECTION_KEY, DROPDOWN_COLLECTION_ITEM_INJECTION_KEY, ElCollection, ElCollectionItem, FIRST_KEYS, FIRST_LAST_KEYS, LAST_KEYS, dropdownItemProps, dropdownMenuProps, dropdownProps } from './components/dropdown/src/dropdown2.mjs';
...
export { tabPaneProps } from './components/tabs/src/tab-pane2.mjs';
