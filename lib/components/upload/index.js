...
var upload$1 = require('./src/upload.js');
var upload = require('./src/upload2.js');
var uploadContent = require('./src/upload-content2.js');
var uploadList = require('./src/upload-list2.js');
